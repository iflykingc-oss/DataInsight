import { pgTable, foreignKey, unique, check, serial, varchar, integer, timestamp, jsonb, text, date } from "drizzle-orm/pg-core"
...
export const users = pgTable("users", {
	...
	unique("users_email_key").on(table.username),
